...
public class Nave
{
    ...
    /**
     * Cria um campo de força com um valor aleatório entre 1 e 5
     */
    public void criarCampoDeForca()
    {
        Random random = new Random();
        campoDeForca = random.nextInt(5) + 1;
    }
    ...
    public void tomarTiro()
    {
        if (estaViva)
        {
            // diminui o campo de força
            campoDeForca--;
            // se o campo de força chegar a zero, a nave morre
            if (campoDeForca == 0)
                {
                    estaViva = false;
                }
